...
class PosPublisher:
    ...
    def __init__(self):
        ...
        rospy.loginfo("Service '/set_init_point' has been registered.")
        self.spin()
    ...
    def get_params(self):
        ...
        rospy.logwarn("pos_dynamic: %s", self.pos_dynamic)
        if self.pos_dynamic:
            self.x_max_amplitude = rospy.get_param('robomaster_om/pos_dynamic_params/x_max_amplitude')
            self.y_max_amplitude = rospy.get_param('robomaster_om/pos_dynamic_params/y_max_amplitude')
            self.z_max_amplitude = rospy.get_param('robomaster_om/pos_dynamic_params/z_max_amplitude')

            self.x_max_freq = rospy.get_param('robomaster_om/pos_dynamic_params/x_max_freq')
            self.y_max_freq = rospy.get_param('robomaster_om/pos_dynamic_params/y_max_freq')
            self.z_max_freq = rospy.get_param('robomaster_om/pos_dynamic_params/z_max_freq')
    ...
    def spin(self):
        ...
        while not rospy.is_shutdown():
            ...
            rospy.logwarn("Point: x: %f, y: %f, z: %f", self.point.x, self.point.y, self.point.z)
...
if __name__ == "__main__":
    ...
    rospy.logwarn("srv_init_pos = rospy.Service('set_init_point', SetLinkState, self.set_new_pos)")
